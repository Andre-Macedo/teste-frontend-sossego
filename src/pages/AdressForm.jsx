...
function AddressForm({ onSubmit, cleanForm, setCurrentPage }) {
        ...
        <>
            ...
            <form name="endereco" onSubmit={onSubmit}>
                <div className="bottomdiv">
                    <label htmlFor="cep">
                        CEP:
                        <input type="number" id="cep" value={cep} onChange={(event) => setCep(event.target.value)} required />
                    </label>
                    <label htmlFor="rua">
                        Rua:
                ...
                <div className="bottomdiv">
                    <div className="bottomdiv2">
                        <label htmlFor="numero">Número:
                            <input type="number" id="numero" value={numero} onChange={(event) => setNumero(event.target.value)} required />
                        </label>
